...
from ..schemas import Book, BookCreate, BookUpdate, ResponseModel
...
@router.post("/", response_model=ResponseModel[Book])
...
@router.put("/{book_id}", response_model=ResponseModel[Book])
